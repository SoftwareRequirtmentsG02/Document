          ...
          <div class="main" align="center">
            ...
            <tr align="center"><td>学习态度</td>
             ...
             <tr align="center"><td>专业能力</td>
              ...
              <td>14</td><td>
              <input type="radio" name="organization" value="100" />A<input type="radio" name="organization" value="80"
               checked="checked" />B
              <input type="radio" name="organization" value="60" />C<input type="radio" name="organization" value="40" />D
              </td></tr> 
              <tr align="center"><td>决策能力</td>
              <td>14</td><td>
              <input type="radio" name="decision" value="100" />A<input type="radio" name="decision" value="80" 
               checked="checked"/>B
            ...
            <input type="radio" name="achievement" value="100" />A<input type="radio" name="achievement" value="80"
             checked="checked" />B
              <input type="radio" name="achievement" value="60" />C<input type="radio" name="achievement" value="40" />D
            </td></tr>
            <tr align="center"><td>综合评价</td><td colspan="2"><input name="evaluation" type="text" size="40" 
            value="请对您的学习情况进行综合评价" /></td></tr>
            <tr align="center"><td>学习展望</td><td colspan="2"><input name="expectation" type="text" size="40" 
            value="请对您下一阶段的学习情况做一个展望" /></td></tr>
