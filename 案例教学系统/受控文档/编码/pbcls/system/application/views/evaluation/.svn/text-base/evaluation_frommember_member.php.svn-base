...
<div class="container">
    ...
    <div class="maincontent">
        ...
        <div class="mainbody">
			<div class="game_nav">
            	PBCLS >> <?php echo $this->session->userdata('instancename'); ?> >> 评价 >>组员的评价
          </div>
            
          <div class="main" align="center">
          <h5>在这里您可以对您可以看您的小组成员对您的评价。</h5>
          <!--
           ...
           <table style="font-size:12px" border="1" width="400">
            ...
            <tr align="center"><td>学习态度</td><td>20</td><td><?php echo $result['attitude']; ?></td></tr>
            <tr align="center"><td>专业能力</td><td>20</td><td><?php echo $result['technique']; ?></td></tr>
            <tr align="center"><td>沟通能力</td><td>20</td><td><?php echo $result['communication']; ?></td></tr>
            <tr align="center"><td>协作能力</td><td>20</td><td><?php echo $result['cooperation']; ?></td></tr>
            <tr align="center"><td>对他人的帮助</td><td>20</td><td><?php echo $result['helpme']; ?></td></tr>
