...
<div class="messagebox">
    ...
    <table id="box" width="100%" border="1"  rules="rows">
		...
		<tr>
			...
			<th width='20%'><?php echo $this->usermodel->getUsername($array['to']);?></th>
	...
	$(".mesTitle").livequery("click",function(){
		...
		?>	
			if( mesid == <?php echo $array['uid'];?>){
				<?php $mesid = $array['uid'];?>
				var mesbody = "<table><tr><th>收件人：</th><th><?php echo $this->usermodel->getUsername($array['to']);?></th></tr>";
					mesbody += "<tr><th>发送时间：</th><th><?php echo $array['sendtime'];?></th></tr>";
					mesbody += "<tr><th>信件内容：</th><th><p><?php echo $array['body'];?></p></th></tr></table>";
				$(".mesContent").empty();
