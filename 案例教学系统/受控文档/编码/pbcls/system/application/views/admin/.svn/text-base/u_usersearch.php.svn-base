...
<div class="maincontent">
  ...
  <div class="mainbody">
      <br />
            <div class="mainbar">
            <form name="typeform" method="post" action="<?php echo site_url('admin/useradmin/complexsearch')?>">
         ...
         <form method="post" action="<?php echo site_url('admin/useradmin/userinfo')?>">
         <div class="mainbox">
         <br/>
             <div class="mainbox1">
