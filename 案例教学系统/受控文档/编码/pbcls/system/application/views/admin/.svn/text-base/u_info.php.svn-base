...
<div class="maincontent">
    ...
    <div class="mainbody">
            ...
            <table width="100" height="30" >
              <tr>             
                ...
                <select name="searchtype" size="1" onChange="changetype()">
                  <option value="general" selected="selected">纵览</option>
         ...
         <div class="mainbox">
              <br/>
            <form method="post" action="<?php echo site_url('admin/useradmin/updateinfo') ?>">
             <table width="640">
              <tr align="center" style="font-size:12px" height="30">
              <th width="300" align="left">用户名：</th>
              <td width="340" style="border-left: thin solid #CACACA" align="center"><input name="username" type="text" value="<?php echo $row['username']?>"></td>
              </tr>
              <tr>
              <td style="font-size:12px">长度必须介于3和20个字符之间.</td><td>&nbsp;</td>
              </tr>
              
              <tr align="left" style="font-size:12px" height="30">
              <th width="300" align="left">注册时间：</th>
              <td width="340" style="border-left: thin solid #CACACA" align="center"><input name="registertime" type="text" value="<?php echo $row['registertime']?>"></td>
              </tr>
              <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
              
              <tr align="left" style="font-size:12px" height="30">
              <th width="300" align="left">用户类型：</th>
              <td width="340" style="border-left: thin solid #CACACA" align="center">
              <input type="text" size="8" value="<?php if($row['groupid'] == 0) echo '管理员';elseif($row['groupid'] == 1) echo '指导者';else echo '学习者'?>">
              ...
              <td width="340" style="border-left: thin solid #CACACA" align="center"><input name="email" type="text" value="<?php echo $row['email']?>"></td>
              </tr>
              <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
              
               <tr align="left" style="font-size:12px" height="30">
              <th width="300" align="left">确认Email地址：</th>
              <td width="340" style="border-left: thin solid #CACACA" align="center"><input name="emailconf" type="text" value=""></td>
              </tr>
              <tr><td style="font-size:12px">您只有在改变用户email地址的时候才需要指定这个.</td><td>&nbsp;</td></tr>
              
              <tr align="left" style="font-size:12px" height="30">
              <th width="300" align="left">新密码：</th>
              <td width="340" style="border-left: thin solid #CACACA" align="center"><input name="password" type="text" value=""></td>
              </tr>
              <tr><td style="font-size:12px">密码长度必须介于 6 和 30 个字符之间.</td><td>&nbsp;</td></tr>
              
               <tr align="left" style="font-size:12px" height="30">
              <th width="300" align="left">确认新密码：</th>
              <td width="340" style="border-left: thin solid #CACACA" align="center"><input name="passwordconf" type="text" value=""></td>
              </tr>
              <tr><td style="font-size:12px">只有在改变密码时您才需要再重复输入一次.</td><td>&nbsp;</td></tr>
