            ...
            <table width="640">
              ...
              <td width="340" style="border-left: thin solid #CACACA" align="center">
               <select name="namebox" size="2" onChange="banselect()" style="width:180">
				 ...
				 {
				 ?>
                  <option value="<?php echo $row['name'] ?>" <?php if($row['name'] == $name) echo "selected" ?> ><?php echo $row['name'] ?></option>
                   <?php 
			     }
				 ?>
                  </select>
              ...
              <form name="deleteregname" method="post" action="<?php echo site_url('admin/useradmin/unbanregname') ?>" >
              <table width="640">
               <?php 
              ...
              <input type="hidden" name="object" value="<?php echo $name ?>"  />
              </form>
           </div>
