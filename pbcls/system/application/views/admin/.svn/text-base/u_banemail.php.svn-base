...
<?php $this->load->view('admin/admin_header'); ?>    
         ...
         <div class="mainbody">
            ...
            <table width="640">
              ...
              <td width="340" style="border-left: thin solid #CACACA" align="center"><input type="text" name="time" size="25"></td>
              </tr>
              
              <tr align="left" style="font-size:12px" height="30">
              <th width="300" align="left">封禁原因：</th>
              <td width="340" style="border-left: thin solid #CACACA" align="center"><input type="text" name="reason" size="25"></td>
              </tr>
