...
<div class="container">
    ...
    <div class="maincontent">
         ...
         <div class="mainbody">
			<div class="game_nav">
            	PBCLS >> <?php echo $this->session->userdata('instancename'); ?> >> 评价 >> 项目经理的评价
            </div>
            
          <div class="main" align="center">
          <h5>在这里您可以对您可以看到知道项目经理对您前一项目阶段的评价。</h5>
          <!--
           ...
           <table style="font-size:12px" border="1" width="400">
            ...
            <tr align="center"><td>学习态度</td><td>20</td><td><?php echo $result['manager_attitude']; ?></td></tr>
            <tr align="center"><td>专业能力</td><td>20</td><td><?php echo $result['manager_technique']; ?></td></tr>
            <tr align="center"><td>沟通能力</td><td>20</td><td><?php echo $result['manager_communication']; ?></td></tr>
            <tr align="center"><td>协作能力</td><td>20</td><td><?php echo $result['manager_cooperation']; ?></td></tr>
            <tr align="center"><td>文档通过率</td><td>20</td><td><?php echo $result['manager_docpassrate']; ?></td></tr>
            <tr align="center"><td>文档完成时间</td><td>20</td><td><?php echo $result['manager_docpasstime']; ?></td></tr>
            <tr align="center"><td>文档风格</td><td>20</td><td><?php echo $result['manager_docstyle']; ?></td></tr>
            <tr align="center"><td>文档创新情况</td><td>20</td><td><?php echo $result['manager_docinnovation']; ?></td></tr>
            <tr align="center"><td>文档正确情况</td><td>20</td><td><?php echo $result['manager_doccorrectness']; ?></td></tr>
            <tr align="center"><td>综合评价</td><td><?php echo $result['manager_score']; ?></td>
            <td><?php echo $result['manager_mark']; ?></td></tr>
            </table>
            <br />
