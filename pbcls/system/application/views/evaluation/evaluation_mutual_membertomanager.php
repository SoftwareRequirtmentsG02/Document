    ...
    <div class="maincontent">
        ...
        <div class="mainbody">
         ...
         <br />
          ...
          <form name="evaluationformanager" method="post" action="<?php echo site_url('evaluation/memberToMemberEvaluationAction') ?>">
             <table style="font-size:12px" border="1" width="400">
              ...
              <tr align="center"><td rowspan="9" width="80">对项目经理<?php echo $username ?></td>
               <td>学习态度</td>
              <td>10</td>
              <td>
              <input type="radio" name="status" value="100" />A<input type="radio" name="status" value="80" checked=
              "checked" />B
              ...
              <td>16</td><td>
              <input type="radio" name="communication" value="100" />A<input type="radio" name="communication" value="80" checked=
              "checked" />B
              <input type="radio" name="communication" value="60" />C<input type="radio" name="communication" value="40" />D
              </td></tr>
              <tr align="center"><td>协作能力</td>
              <td>16</td><td>
              <input type="radio" name="cooperation" value="100" />A<input type="radio" name="cooperation" value="80" checked=
              "checked" />B
              <input type="radio" name="cooperation" value="60" />C<input type="radio" name="cooperation" value="40" />D
              </td></tr>   
              <tr align="center"><td>组织能力</td>
              <td>16</td><td>
              <input type="radio" name="organization" value="100" />A<input type="radio" name="organization" value="80" checked=
              "checked" />B
              <input type="radio" name="organization" value="60" />C<input type="radio" name="organization" value="40" />D
              </td></tr> 
              <tr align="center"><td>决策能力</td>
              <td>16</td><td>
              <input type="radio" name="decision" value="100"/>A<input type="radio" name="decision" value="80"  checked=
              "checked" />B
              <input type="radio" name="decision" value="60" />C<input type="radio" name="decision" value="40" />D
              </td></tr>             
              <tr align="center"><td>对自己的帮助</td>
              <td>10</td><td>
              <input type="radio" name="helpme" value="100" />A<input type="radio" name="helpme" value="80" checked=
              "checked" />B
              <input type="radio" name="helpme" value="60" />C<input type="radio" name="helpme" value="40" />D
              </td></tr>
              <tr align="center"><td width="100">综合评价</td><td colspan="2"><input type="text" name="mark"
               value="请做出综合性评价" /></td></tr>               
