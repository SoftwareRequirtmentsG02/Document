...
<div class="container">
    ...
    <div class="maincontent">
        ...
        <div class="mainbody">
          ...
          <h5>在这里您可以对您可以看到知道小组成员对您前一项目阶段的评价。</h5>
          <!--
           ...
           <table style="font-size:12px" border="1" width="400">
            ...
            <tr align="center"><td>学习态度</td><td>10</td><td><?php echo $result['attitude']; ?></td></tr>
            <tr align="center"><td>专业能力</td><td>16</td><td><?php echo $result['technique']; ?></td></tr>
            <tr align="center"><td>沟通能力</td><td>16</td><td><?php echo $result['communication']; ?></td></tr>
            <tr align="center"><td>协作能力</td><td>16</td><td><?php echo $result['cooperation']; ?></td></tr>
            <tr align="center"><td>组织能力</td><td>16</td><td><?php echo $result['organization']; ?></td></tr>
            <tr align="center"><td>决策能力</td><td>16</td><td><?php echo $result['decision']; ?></td></tr>
            <tr align="center"><td>对他人的帮助</td><td>10</td><td><?php echo $result['helpme']; ?></td></tr>
            <tr align="center"><td>综合得分</td><td colspan="2"><?php echo $result['score']; ?></td></tr>
            </table>
            <br />
